...
public class FullScreenVideoActivity extends AppCompatActivity {
    ...
    private ImageView imgAddress,imgMobile,imgEmail;
    private TextView txtEmail;

    private static String selectedUrl = "http://account7.livebox.co.in/applehls/apple.m3u8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgMobile = (ImageView) findViewById(R.id.imgCall);
        imgEmail = (ImageView) findViewById(R.id.imgMail);
        ...
        imgAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mapIntent.resolveActivity(FullScreenVideoActivity.this.getPackageManager()) != null) {
                    FullScreenVideoActivity.this.startActivity(mapIntent);
                }
            }
        });
        ...
        imgMobile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isPermissionGranted()) {
                    try {
                       startActivity(new Intent("android.intent.action.CALL", Uri.parse("tel:7204086662")));
   ...
   private void changeOrientation() {
    ...
    public boolean isPermissionGranted() {
        if (Build.VERSION.SDK_INT < 23 || checkSelfPermission("android.permission.CALL_PHONE") == PackageManager.PERMISSION_GRANTED) {
            return true;
        }
